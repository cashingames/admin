<x-finance-layout>
    ...
    <ul
        ...
        <li class="w-full">
            ...
            class="inline-block p-4 w-full bg-white hover:text-gray-700 hover:bg-gray-50 focus:ring-4 focus:ring-blue-300 focus:outline-none uppercase dark:hover:text-white dark:bg-gray-800 dark:hover:bg-gray-700">All Transactions</a>
        </li>
        <li class="w-full">
    ...
    <div class="pt-8">
        <livewire:finance.wallet-fundings-table exportable hideable="select" />
    </div>
    @else
