<div class="w-full max-w-lg pt-6">
    ...
    <div class="flex justify-center mb-4">
        ...
        <button wire:click="$emit('openModal', 'modals.edit-approved-question', {{ json_encode(["question"=> $question->id])
            }})"
        ...
        @if ($canPublish)
        @if ($question->is_published)
        <button wire:click="$emit('openModal', 'modals.publish-approved-question', {{ json_encode(["question"=>
