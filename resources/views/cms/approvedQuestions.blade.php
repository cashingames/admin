<x-cms-layout>
    ...
    <ul
        ...
        <li class="w-full">
            ...
            class="inline-block p-4 w-full text-gray-900 bg-blue-300 focus:ring-4 focus:ring-blue-300 active focus:outline-none dark:bg-gray-700 dark:text-white" aria-current="page">Approved</a>
        </li>
        <li class="w-full">
