...
class EditRejectedQuestion extends ModalComponent
{
    public $question;
    ...
    public function editQuestion(Request $request)
    {
        ...
        if ($validator->fails()) {
            return redirect()->to('/cms/questions/rejected')->withErrors($validator);
        }
    ...
    {
        return view('livewire.modals.edit-rejected-question');
    }
